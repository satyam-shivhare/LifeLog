...
const DropDown = ({
  ...
  const [isDropdownListVisible, setIsDropdownListVisible] =
  ...
  return (
    <>
      ...
      <Modal visible={isDropdownListVisible} transparent onRequestClose={() => setIsDropdownListVisible(false)}>
        ...
        <FlatList
          ...
          renderItem={({
            ...
            return (
              ...
              >
                <Text className="text-center text-xl my-3 ">{item.label}</Text>
              </TouchableOpacity>
            );
          }}
        />
